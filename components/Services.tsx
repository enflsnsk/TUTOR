      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div>
            ...
            <h3 className="text-4xl font-bold text-white">전문 교육 및 컨설팅</h3>
          </div>
          <p className="text-slate-400 mt-4 md:mt-0 max-w-sm">기업과 개인의 필요에 맞춘 최적화된 AI 도입 솔루션을 제공합니다.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          {services.map((service, idx) => (
            ...
            >
              <div className="relative glass rounded-3xl overflow-hidden transition-all duration-500 transform-gpu group-hover:rotate-y-6 group-hover:rotate-x-2">
